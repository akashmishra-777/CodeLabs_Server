...
async function sendMail(req,res){
    ...
    const transporter = nodemailer.createTransport({
      ...
      const mailOptions = {
        ...
        html: `<p>Dear <b>${req.body.name}</b>, your Sign Up OTP (One Time Password) is :<h2> ${OneTimePassword}</h2> It is valid only for 5 minutes. Please do not share it with anyone.</p>
